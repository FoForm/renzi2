      ...
      <div>
        <div class="fl headL">
          ...
          <div class="headInfoTip">
            ...
            <p class="lastChild">早安，{{companyName}}，祝你开心每一天！</p>
          </div>
        </div>
        <div class="fr" />
      </div>
    ...
    <el-row type="flex" justify="space-between">
      ...
      <el-col :span="13" style="padding-right: 26px">
        ...
        <el-card class="box-card">
          ...
          <!-- 放置日历组件 -->
          <WorkCalender :currentDate="new Date()"/>
        </el-card>
        <!-- 公告 -->
        <el-card class="box-card">
...
import WorkCalender from '@/views/dashboard/components/work-calendar.vue'
export default {
  name: "Dashboard",
  components: {
    WorkCalender
